...
U_NP,              U_NP,              U_LT(U_NUM, SPACE),U_LT(U_MEDIA, ESC),U_LT(U_NAV, TAB),U_LT(U_SYM, RET),  U_LT(U_MOUSE, DEL), U_LT(U_FUN, BSPC),  U_NP,              U_NP

#define MIRYOKU_LAYER_NAV \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp INS,           &kp HOME,          &kp UP,            &kp END,           &kp PG_UP,         \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &kp ESC,           &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp RIGHT,         &kp PG_DN,         \
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &kp ESC,           &kp EQUAL,         &kp N4,            &kp N5,            &kp N6,            &kp SEMI,          \
...
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          &kp DEL,           &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
...
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &kp SLCK,          &kp DEL,           &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp F10,           &kp F1,            &kp F2,            &kp F3,            &kp PAUSE_BREAK,   U_NA,              &u_to_U_FUN,       &u_to_U_NUM,       &kp RALT,          U_NA,              \
...
U_NA,              &kp RALT,          &u_to_U_MOUSE,     &u_to_U_MEDIA,     U_NA,              &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_MOUSE,     &u_to_U_MEDIA,     &kp RALT,          U_NA,              \
